...
Zappy::Interface::Interface()
{
    ...
    player_orientation[1][0] = sf::IntRect(250, 0, 250, 250);
    player_orientation[1][1] = sf::IntRect(250, 250, 250, 250);
    player_orientation[2][2] = sf::IntRect(250, 500, 250, 250);
    player_orientation[3][3] = sf::IntRect(250, 750, 250, 250);
