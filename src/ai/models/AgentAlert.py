...
class AgentAlerts(AgentInfo):
    ...
    def checkAlerts(self) -> list[str]:
        ...
        if (playerLevel == 3 and self.agent.getInventory("linemate") >= 2 and self.agent.getTimeUnits() >= 756 and self.alerts.count("incantationNeeded_4") == 0 and
        ...
        if (playerLevel == 4 and self.agent.getInventory("linemate") >= 1 and self.agent.getTimeUnits() >= 756 and self.alerts.count("incantationNeeded_5") == 0 and
            self.agent.getInventory("deraumere") >= 1 and 
        ...
        if (playerLevel == 5 and self.agent.getInventory("linemate") >= 1 and self.agent.getTimeUnits() >= 756 and self.alerts.count("incantationNeeded_6") == 0 and
        ...
        if (playerLevel == 6 and self.agent.getInventory("linemate") >= 1 and self.agent.getTimeUnits() >= 756 and self.alerts.count("incantationNeeded_7") == 0 and
            self.agent.getInventory("deraumere") >= 2 and
        ...
        if (playerLevel == 7 and self.agent.getInventory("linemate") >= 2 and self.agent.getTimeUnits() >= 756 and self.alerts.count("incantationNeeded_8") == 0 and
            self.agent.getInventory("deraumere") >= 2 and
            self.agent.getInventory("sibur") >= 2 and
