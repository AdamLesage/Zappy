...
SRC_SEVER	=	src/server/main.c											\
			...
			src/server/dataManagment/client/add_client_on_network.c			\
			src/server/dataManagment/client/find_client_on_network.c		\
			src/server/dataManagment/client/delete_client_of_network.c		\
