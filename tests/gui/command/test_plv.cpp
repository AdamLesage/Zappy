...
Test(plv, test_plv_apply_changes_throw)
{
    ...
    int timeUnit = 1;
    bool isRunning = true;
    cr_assert_throw(plv.applyChanges(parsedData, size_map, tiles, players, eggs, timeUnit, isRunning), Zappy::CommandError);
}
...
Test(plv, test_plv_apply_changes)
{
    ...
    int timeUnit = 1;
    bool isRunning = true;
    cr_assert_no_throw(plv.applyChanges(parsedData, size_map, tiles, players, eggs, timeUnit, isRunning), Zappy::CommandError);
